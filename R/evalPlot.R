...
dir.create('./plotEval', recursive = TRUE)
...
ggsave(paste('./plotEval/eval.pdf', sep = '_'), width = 8, height = 12)
...
geom_path(data = ts[ts$src != 'data'& !is.na(ts$value),], aes(x = year, y = value, col = src), linetype = 'dashed') +
facet_grid(variable ~ site, scale = "free") +
theme_light() +
theme(panel.grid.minor = element_blank(),
      # panel.grid.major = element_blank(),
      ...
      legend.title=element_blank(),
      panel.spacing = unit(20, 'pt'))
ggsave(paste('./plotEval/ts.pdf', sep = '_'), width = 8, height = 12)
...
theme(panel.grid.minor = element_blank(),
      ...
      legend.title=element_blank(),
      panel.spacing = unit(20, 'pt'))
ggsave(paste('./plotEval/evalSpKroof.pdf', sep = '_'), width = 8, height = 8)
...
ggplot() +
geom_line(data = ts[ts$src == 'data' & !is.na(ts$value),], aes(x = year, y = value, col = src)) +
geom_line(data = ts[ts$src != 'data' & !is.na(ts$value),], aes(x = year, y = value, col = src), linetype = 'dashed') +
facet_grid(variable ~ species, scale = "free") +
theme_light() +
theme(panel.grid.minor = element_blank(),
      # panel.grid.major = element_blank(),
      ...
      legend.title=element_blank(),
      panel.spacing = unit(20, 'pt'))
ggsave(paste('./plotEval/tsSpKroof.pdf', sep = '_'), width = 8, height = 8)
